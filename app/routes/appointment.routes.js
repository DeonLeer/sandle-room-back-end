...
module.exports = function (app) {
	...
	app.get("/api/upcomingappointments", [authJwt.verifyToken], controller.getUpcomingAppointments);

	app.get("/api/appointmenthistory", [authJwt.verifyToken], controller.getAppointmentHistory);
	...
	app.patch("/api/appointments/notes", [authJwt.verifyToken, authJwt.isAdmin], controller.saveNotes);
